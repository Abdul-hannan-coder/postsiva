...
import useYoutubeAuth from '@/lib/hooks/auth/platforms/youtube/useYoutubeAuth';
...
export default function YouTubePage() {
  ...
  const { isLoading, error, initiateYoutubeConnect } = useYoutubeAuth();

  const handleConnect = async () => {
    if (!isAuthenticated) {
      window.location.href = '/auth/signin?next=/platforms/youtube';
      return;
    }
    try {
      await initiateYoutubeConnect();
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-6">
          <div className="bg-gray-900 rounded-2xl p-8 max-w-md w-full border border-gray-800 relative">
            ...
            <div className="space-y-4">
              ...
              >
                {isLoading ? 'Opening YouTube...' : 'Authorize YouTube Access'}
              </button>
              <button
                onClick={() => setShowConnectForm(false)}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="https://terms.postsiva.com/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-orange-400 transition-colors text-xs sm:text-sm">Terms & Conditions</Link></li>
                <li><Link href="https://privacy-policy.postsiva.com/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-orange-400 transition-colors text-xs sm:text-sm">Privacy Policy</Link></li>
