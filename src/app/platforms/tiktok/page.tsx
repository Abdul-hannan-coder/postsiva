...
import useTiktokAuth from '@/lib/hooks/auth/platforms/tiktok/useTiktokAuth';
...
export default function TikTokPage() {
  ...
  const { isLoading, error, initiateTikTokConnect } = useTiktokAuth();

  const handleConnect = async () => {
    if (!isAuthenticated) {
      // Redirect to signin if not authenticated
      window.location.href = '/auth/signin?next=/platforms/tiktok';
      return;
    }
    try {
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-6">
          <div className="bg-gray-900 rounded-2xl p-8 max-w-md w-full border border-gray-800 relative">
            ...
            <div className="space-y-4">
              ...
              >
                {isLoading ? 'Opening TikTok...' : 'Authorize TikTok Access'}
              </button>
              <button
                onClick={() => setShowConnectForm(false)}
